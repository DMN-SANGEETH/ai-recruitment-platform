...
class JobMatcher:
    ...
    def match_resume_to_jobs(self, resume_data: Dict[str, Any], limit: int = 5) -> List[Dict[str, Any]]:
        """Match a resume to job descriptions using client-side vector similarity"""
        try:
            ...
            if "embedding" not in resume_data or not resume_data["embedding"]:
                ...
                # Update the resume in DB with the new embedding if it has an ID
