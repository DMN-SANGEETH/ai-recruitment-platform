...
class JobService:
    ...
    def get_job_by_id(self,
        ...
        try:
            ...
            return None
                ...
                logger.error("Unexpected error getting job ID %s: %s",
                             job_id,
                             e,
                             exc_info=True
                             )
    ...
    def get_jobs_by_domain(self,
        ...
        try:
            ...
            logger.error("Error getting jobs by domain: %s", e)
            return []
    ...
    def get_job_matches_for_resume(self,
        ...
        try:
            ...
            logger.error("Failed to get job matches for resume: %s",
                         str(e),
                         exc_info=True
                         )
            return []

    def search_jobs_by_keyword(self,
                               keyword: str,
                               limit: int = 10
                               ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("Error searching jobs by keyword '%s': %s",
                         keyword,
                         e,
                         exc_info=True
                         )
